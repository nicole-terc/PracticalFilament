...
internal val ComparisonPresetSpecs = listOf(
    ...
    ComparisonPresetSpec(
        ...
        baseColor = ComposeColor(red = 0.85f, green = 0.85f, blue = 0.88f, alpha = 1f),
        shadowColor = ComposeColor(red = 0.23f, green = 0.23f, blue = 0.25f, alpha = 1f),
        highlightColor = ComposeColor(red = 0.97f, green = 0.98f, blue = 1f, alpha = 1f),
        rimColor = ComposeColor(red = 0.82f, green = 0.84f, blue = 0.88f, alpha = 1f),
        veinColor = ComposeColor(red = 0.87f, green = 0.88f, blue = 0.91f, alpha = 1f),
