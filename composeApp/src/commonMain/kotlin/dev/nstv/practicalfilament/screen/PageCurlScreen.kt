                ...
                onEngineReady = { readyEngine ->
                    ...
                    renderableHandle = readyEngine.createCustomRenderable(
                        CustomRenderableConfig(
                            ...
                            strideBytes = 20,
                            attributes = listOf(
                                VertexAttributeLayout(VertexAttribute.POSITION, AttributeDataType.FLOAT3, 0),
                                VertexAttributeLayout(VertexAttribute.UV0, AttributeDataType.FLOAT2, 12),
                            ),
                    ...
                    if (renderableHandle <= 0) {
                        ...
                        readyEngine.setRenderableTransform(renderableHandle, buildPageTransform(pageState.rigidAngleRadians))
                    }
                },
            )
        },
