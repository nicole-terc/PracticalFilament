        ...
        view = {
            FilamentView(
                ...
                onEngineReady = { readyEngine ->
                    ...
                    engine = readyEngine
                    cubeHandle =
                        readyEngine.createCubeRenderable(loaded.instanceHandle, size = 1.5f)
                    planeHandle = readyEngine.createPlaneRenderable(
                    ...
                    if (cubeHandle <= 0) {
                        supportNotice =
                            "This sample needs cube geometry support from the platform engine."
                        return@FilamentView
                    }
